...
var DeviceController = /** @class */ (function () {
    ...
    DeviceController.register = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    ...
                    res.status(500).json((0, helpers_1.errorResponse)('INTERNAL_ERROR', 'Failed to register device'));
                }
                return [2 /*return*/];
            });
        });
    };
    DeviceController.getMe = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    if (!req.user) {
                    ...
                    res.status(500).json((0, helpers_1.errorResponse)('INTERNAL_ERROR', 'Failed to get user info'));
                }
                return [2 /*return*/];
            });
        });
    };
    DeviceController.updateMe = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, device_service_1.DeviceService.updateUser(req.user.id, req.body)];
                    case 1:
                        updatedUser = _a.sent();
                        res.status(200).json((0, helpers_1.successResponse)({
                            id: updatedUser.id,
